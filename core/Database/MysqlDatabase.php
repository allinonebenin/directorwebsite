...
$pdo=new PDO('mysql:dbname=bd_director;host=localhost','root','root');
$db_name='bd_director', $db_user='root', $db_pass='root', $db_host='localhost'
*/
		public function __construct($db_name='bd_director', $db_user='root', $db_pass='root', $db_host='localhost')
		{
